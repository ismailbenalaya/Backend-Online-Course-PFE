...
var schemaFormateurArchive = mongoose.Schema({
...
schemaFormateurArchive.methods.comparePassword = async  function (formteurPassword){
    return bdcypt.compare(formteurPassword,this.password)
 }

module.exports = mongoose.model('FormateurArcheve',schemaFormateurArchive)